...
r'''Unstacks the register_groups and assigns registers to each of them.
...
def attempt_register_allocation(sizes, code_seqs):
    ...
    max_stacking_order = stack_register_groups()

    return assign_registers(max_stacking_order)
